...
wstring alltext[][2] =
{
    {L"�������", L"HUMAN"},
    {L"�����", L"BOT"},
    {L"����������: WASD/���������   �����: ������   ��������: T   �����: Esc   ��������� ������: K", L"Control: WASD/Arrows   Bomb: Space   Talk: T   Exit: Esc   Magic tangle: K"},
    {L"��������", L"Maze"},
    {L"����� ����: �������", L"GAME MODE: HUMAN"},
    {L"����� ����: �����", L"GAME MODE: BOT"},
    {L"�������� ����� ��������: ", L"TREASURES LEFT: "},
    {L"������� F ����� ����������", L"PRESS F FOR TALKING"},
    {L"����� �����������: ", L"Time: "},
    {L"����� ������: ", L"Killed enemies: "},
    {L"������ ����� ������������ ���: ", L"Buddies help: "},
    {L"���� ������ �������� ���: ", L"Foes tricks: "},
    ...
    {L"����������� ������: ", L"Doors failed: "},
    {L"�������� �����: ", L"Damage received: "},
    {L"������� R ��� ��������", L"Press R for restart"},

    {L"������� F, ����� ����������", L"Press F for continue"},

    {L"-\"�����, ��� ���� ������\"", L"-\"Hey, nice to see you\""},
    {L"-\"�����, � ������, ���� ������, � ������ ����\"", L"-\"Hey, I see you are damaged, let me help\""},
    {L"-\"�����, ������, � ���� ��������� �����������\"", L"-\"Hey, sorry i am out of meds\""},

    {L"-\"���, ����� ��?! �� ��, ������������ �����, �� ���!\"", L"-\"Argh, again you?! Hey, monsters, he is here!\""},
    {L"-\"���� ������\"", L"-\"Go away\""}
};
